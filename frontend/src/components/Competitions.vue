<template>
    <div class="hello">
        <div class="container">
            <h3 class="text-center text-white">Weź udział w naszych konkursach</h3>
            <hr class="mt-4" style="border-color: mediumaquamarine" />
            <hr>
            <h2 class="my-4 text-center text-white"> Zagłosuj na dowolną liczbę gier w każdym konkursie i pomóż nam wybrać tę najlepszą!</h2>
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-md-3 my-2"  :key="item.group_id" v-for="item in data">
                    <b-card class="mb-2 h-100">
                        ...
                        <b-button class="games__button" @click.once="handleDetails(item.group_id)"> Weź udział </b-button>
                    </b-card>
                </div>
            </div>
